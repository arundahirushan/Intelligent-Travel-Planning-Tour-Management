...
public class BookingService : IBookingService
{
    ...
    public BookingService(AppDbContext db, IHotelService hotelService)
    {
        _db           = db;
        _hotelService = hotelService;
    }

    // Create a new booking (starts as Held).
    ...
    public async Task<BookingSummaryDto> CreateAsync(CreateBookingDto dto, int travelerId)
    {
    ...
    // Returns all bookings that belong to the requesting traveler

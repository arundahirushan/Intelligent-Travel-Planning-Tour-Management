...
import { getMyProfile, updateMyProfile, getDeletionEligibility, deleteMyAccount } from '../../../services/hotelOwnerApi';
          ...
          <div className="border border-status-danger/30 bg-status-danger/5 rounded-xl p-[var(--space-lg)]">
            ...
            {eligibilityLoading ? (
              ...
              <div className="space-y-3">
                ...
                <Link to="/hotel-owner/hotels" className="text-primary hover:underline text-sm font-bold inline-flex items-center gap-1">
                  <span>→</span> View My Hotels
                </Link>
              </div>
            ) : (
              <button 
